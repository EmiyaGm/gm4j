...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`gm4j` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `user`(`id`,`username`,`password`,`state`,`create_time`) values (1,'gm','121411',NULL,'2016-12-17 12:59:59');
